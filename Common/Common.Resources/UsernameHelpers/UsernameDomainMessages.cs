...
public static class UsernameDomainMessages
{
    ...
    /// </summary>
    public const string USERNAME_LONGER_MAX_LENGTH_ERROR = "The Username is longer than the allowed length of the user name. Max length - {0}, current length - {1}";

    /// <summary>
    /// Текст ошибки при попытке создать Username короче установленного
    /// </summary>
    public const string USERNAME_SHORTER_MIN_LENGTH_ERROR = "The Username is shorter than the allowed length of the user name. Min length - {0}, current length - {1}";
