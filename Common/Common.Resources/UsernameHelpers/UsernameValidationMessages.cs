...
public static class UsernameValidationMessages
{
    ...
    /// </summary>
    public const string USERNAME_EMPTY_ERROR = "The email cannot be empty.";

    /// <summary>
    /// Текст ошибки при попытке передать строку в Username с некорректной длиной
    /// </summary>
    public const string USERNAME_LENGTH_ERROR = "The username must be no more than {0} characters and no less than {1}.";

    /// <summary>
    /// Текст ошибки при попытке передать строку в Username в недопустимом формате
    /// </summary>
    public const string USERNAME_FORMAT_ERROR = "Invalid username format.";
}